    ...
    <DayPicker
      ...
      classNames={{
        ...
        nav_button: cn(
          ...
          "h-7 w-7 bg-transparent p-0 border-zinc-700 text-zinc-400 hover:bg-zinc-800 hover:text-zinc-100"
        ),
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 font-normal text-zinc-300 hover:bg-zinc-800 hover:text-zinc-100 aria-selected:opacity-100"
        ),
        ...
        day_outside:
          "day-outside text-zinc-600 aria-selected:bg-zinc-800/50 aria-selected:text-zinc-400",
        day_disabled: "text-zinc-600",
        day_range_middle: "aria-selected:bg-zinc-800 aria-selected:text-zinc-300",
